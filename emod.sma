...
public plugin_init()
{
    register_plugin("EMod", VERSION, AUTHOR);
...
public ibm_say_main()
{
	register_saycmd("respawn", "RespawnPlayer", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("god", "GodMode", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("noclip", "Noclip", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("hp", "SetHp", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("kill", "KillPlayer", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("armor", "SetArmor", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("give", "GiveItem", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("model", "ChangeModel", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("name", "ChangeName", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("resetplayer", "ResetPlayer", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("setmoney", "SetMoney", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("addmoney", "AddMoney", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("getmoney", "GetMoney", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("gravity", "ChangeGravity", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("goto", "TeleportToPlayer", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("bring", "BringPlayer", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("survival", "SurvivalMode", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("classic", "ClassicMode", ADMIN_ADMIN, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("saveloc", "SaveLoc", ADMIN_ALL, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("playerloc", "PlayerLoc", ADMIN_ALL, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("teleport", "TeleportLoc", ADMIN_ALL, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("buy", "ShopMenu", ADMIN_ALL, 1, "", "info", "[EMod] ", false, false, false);
	register_saycmd("shop", "ShopMenu", ADMIN_ALL, 1, "", "info", "[EMod] ", false, false, false);
    register_saycmd("gift", "SendMoney", ADMIN_ALL, 1, "", "info", "[EMod] ", false, false, false);
}
public plugin_cfg()
{
...
{ 
	new g[32];
	format(g,31,"EMod v%s",VERSION);
	forward_return(FMV_STRING,g);
	return FMRES_SUPERCEDE;
	return PLUGIN_HANDLED;
} 
public ECommandsText(){
	client_print(0, print_chat, "[EMod] v%s by Esat Efe", VERSION);
	set_task(120.0, "ECommandsText");
	return PLUGIN_HANDLED;
}
public ShowData(){
	...
	for(new g=0;g<iNum;g++)
	{
		...
		if(is_user_connected(i) && nvault_get( g_Vault , szKey , szData , charsmax( szData ) ))
		{
			...
			show_hudmessage(i, "------> EMod v%s <------^n- Bakiye: %i TL^n- github: esatefekorkmaz", VERSION, iMoney);
			if(!is_user_alive(i)){
...
public GiveTL(){
	...
	for(new g=0;g<iNum;g++)
	{
		...
		if(is_user_connected(i) && nvault_get( g_Vault , szKey , szData , charsmax( szData ) ) && iMoney < 200000)
		{
					...
					client_print(i, print_chat, "[EMod] Sunucuda oynadiginiz icin 10 TL elde ettiniz.");
		}
		else if(iMoney >= 200000){
			client_print(i, print_chat, "[EMod] Bakiye limiti asildi. Daha fazla para kazanamazsiniz. (Limit: 200000 TL)");
		}
	}
	set_task(60.0, "GiveTL");
}
public SendMoney(id)
{
	...
	if(target && iMoney1 >= str_to_num(arg2)){
		...
		client_print(id, print_chat, "[EMod] Oyuncuya %s TL para verildi: %s", arg2, arg1);
		client_print(target, print_chat, "[EMod] Oyuncu size %s TL para verdi: %s", arg2, name);
							new szMoney[7];        //Data holder for the money amount
...
public RespawnPlayer(id)
{
	...
	if(target && !is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncu canlandirildi: %s", name, arg1);
		spawn(target);
	}
    return PLUGIN_HANDLED;
}
public GodMode(id)
{
	...
	new target = find_player("a", arg1);
	if(target && is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncunun olumsuzlugu degistirildi: %s", name, arg1);
...
public Noclip(id)
{
	...
	new target = find_player("a", arg1);
	if(target && is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncunun noclip modu degistirildi: %s", name, arg1);
...
public SetHp(id)
{
	...
	new target = find_player("a", arg1);
	if(target && is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncunun sagligi degistirildi: %s", name, arg1);
...
public SetArmor(id)
{
	...
	new target = find_player("a", arg1);
	if(target && is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncunun zirhi degistirildi: %s", name, arg1);
...
public GiveItem(id)
{
	...
	new target = find_player("a", arg1);
	if(target && is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncuya esya verildi: %s", name, arg1);
...
public ChangeModel(id)
{
	...
	new target = find_player("a", arg1);
	if(target && is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncunun modeli degistirildi: %s", name, arg1);
...
public ChangeName(id)
{
	...
	new target = find_player("a", arg1);
	if(target && is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncunun ismi degistirildi: %s", name, arg1);
...
public ResetPlayer(id)
{
	...
	if(target && is_user_alive(target)){
		...
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncu sifirlandi: %s", name, arg1);
...
public SetMoney(id)
{
	...
	if(target && is_user_alive(target)){
		new szKey[40];
		formatex( szKey , charsmax( szKey ) , "%sMONEY" , g_szAuthID[target] );
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncunun parasi degistirildi: %s", name, arg1);
							new szMoney[7];        //Data holder for the money amount
...
public AddMoney(id)
{
	...
	if(target && is_user_alive(target)){
		...
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncuya para verildi: %s", name, arg1);
							new szMoney[7];        //Data holder for the money amount
...
public GetMoney(id)
{
	...
	if(target && is_user_alive(target)){
		...
		formatex( szKey , charsmax( szKey ) , "%sMONEY" , g_szAuthID[target] );
		new iMoney = nvault_get( g_Vault , szKey );
		client_print(id, print_chat, "[EMod] %s adli oyuncunun parasi: %i", arg1, iMoney);
	}
    return PLUGIN_HANDLED;
}
public KillPlayer(id)
{
	...
	new target = find_player("a", arg1);
	if(target && is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncu olduruldu: %s", name,arg1);
...
public ChangeGravity(id)
{
	...
	new target = find_player("a", arg1);
	if(target && is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncunun yer cekimi degistirildi: %s", name, arg1);
...
public TeleportToPlayer(id)
{
	...
	if(target && is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncuya isinlandiniz: %s", name, arg1);
...
public BringPlayer(id)
{
	...
	if(target && is_user_alive(target)){
		client_print(0, print_chat, "[EMod] ADMIN %s: Oyuncu size isinlandi: %s", name, arg1);
...
public PlayerLoc(id)
{
	...
	if(is_user_alive(target)){
		client_print(id, print_chat, "[EMod] Oyuncuya isinlanma istegi gonderildi: %s", arg1);
		new title[128];
		...
		switch( item )
		{
			case 0:
			{
				if(is_user_alive(id)){
					...
					client_print(target, print_chat, "[EMod] %s isinlanma istegini kabul etti", name);
					new origin[3];
					get_user_origin(id, origin);
					set_user_origin(target, origin);
				}
...
{
	if(is_user_alive(id)){
		client_print(id, print_chat, "[EMod] Basariyla lokasyon kaydedildi. Daha sonra 5 TL karsiliginda /teleport yazarak buraya isinlanabilirsiniz");
		new origin[3];
		get_user_origin(id, origin);	
		loc[id] = origin;
	}
 ...
 public ShopMenu(id)
{
	...
	if(is_user_alive(id) && nvault_get( g_Vault , szKey , szData , charsmax( szData ) )){
		new menu = menu_create( "\rEMod Shop Menu", "shopmenu_handler" );
		...
		switch( item )
		{
			case 0:
			{
				new szData[8];
					...
					new iMoney = nvault_get( g_Vault , szKey );
				if(is_user_alive(id) && nvault_get( g_Vault , szKey , szData , charsmax( szData ) )){
					new menu = menu_create( "\rEMod Shop Menu", "shopmenuweapon_handler" );
			...
			case 1:
			{
				new szData[8];
					...
					new iMoney = nvault_get( g_Vault , szKey );
				if(is_user_alive(id) && nvault_get( g_Vault , szKey , szData , charsmax( szData ) )){
					new menu = menu_create( "\rEMod Shop Menu", "shopmenuammo_handler" );
			...
			case 2:
			{
				new szData[8];
					...
					new iMoney = nvault_get( g_Vault , szKey );
				if(is_user_alive(id) && nvault_get( g_Vault , szKey , szData , charsmax( szData ) )){
					new menu = menu_create( "\rEMod Shop Menu", "shopmenuesya_handler" );
 ...
 public shopmenuweapon_handler( id, menu, item )
 {
		switch( item )
		{
			case 0:
			{
				...
				new iMoney = nvault_get( g_Vault , szKey );
				if(iMoney >= 100){
					client_print(id, print_chat, "[EMod] Basariyla M249 satin aldiniz.");
					...
					client_print(id, print_chat, "[EMod] Bakiyeniz yetersiz.");
				}
				menu_destroy( menu );
				return PLUGIN_HANDLED;
			}
			case 1:
			{
				...
				new iMoney = nvault_get( g_Vault , szKey );
				if(iMoney >= 500){
					client_print(id, print_chat, "[EMod] Basariyla Gauss satin aldiniz.");
 ...
 public shopmenuesya_handler( id, menu, item )
 {
		switch( item )
		{
			case 0:
			{
				...
				new iMoney = nvault_get( g_Vault , szKey );
				if(iMoney >= 50){
					client_print(id, print_chat, "[EMod] Basariyla Longjump satin aldiniz.");
 ...
 public shopmenuammo_handler( id, menu, item )
 {
		switch( item )
		{
			case 0:
			{
				...
				new iMoney = nvault_get( g_Vault , szKey );
				if(iMoney >= 10){
					client_print(id, print_chat, "[EMod] Basariyla 556 satin aldiniz.");
			...
			case 1:
			{
				...
				new iMoney = nvault_get( g_Vault , szKey );
				if(iMoney >= 50){
					client_print(id, print_chat, "[EMod] Basariyla Battery satin aldiniz.");
 ...
 public telemenu_handler( id, menu, item )
 {
		switch( item )
		{
			case 0:
			{
				...
				new iMoney = nvault_get( g_Vault , szKey );
				if(iMoney >= 5){
					client_print(id, print_chat, "[EMod] Basariyla isinlandiniz.");
		...
		switch( item )
		{
			case 0:
			{
				...
				if(iMoney >= 100){
					new origin[3];
					get_user_origin(id, origin);
					client_print(id, print_chat, "[EMod] Basariyla yeniden canlandiniz.");
					spawn(id);
					set_user_origin(id, origin);
					new szKey[40];
					formatex( szKey , charsmax( szKey ) , "%sMONEY" , g_szAuthID[id] );
